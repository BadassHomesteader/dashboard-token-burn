...
async function generateTokenBurn(forceRefresh = false) {
    ...
    const insights = generateInsights(claude, classified, forceRefresh);
    ...
    const result = {
        ...
        timezone: require('./daybucket').TZ_LABEL, // days bucketed in this tz (default: system local)
        ...
        recent,
        insights,
        patterns: { byHour: claude.byHour || new Array(24).fill(0) },
