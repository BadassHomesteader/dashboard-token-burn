...
const _hourFmt = new Intl.DateTimeFormat('en-GB', { timeZone: TZ, hour: '2-digit', hour12: false });
/** ISO timestamp → hour of day 0–23 in the configured timezone. */
function hourBucket(isoTs) {
    try { return parseInt(_hourFmt.format(new Date(isoTs)), 10) % 24; } catch { return 0; }
}

module.exports = { dayBucket, hourBucket, TZ, TZ_LABEL };
